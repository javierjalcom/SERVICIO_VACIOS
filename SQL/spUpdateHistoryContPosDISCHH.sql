...
--DESCRIPCION:  
--             Se inserta un registro en la tabla de Histórico de Posición del Contenedor 
--PARAMETROS:   
--             UniversalId   : Universal Id del Contenedor en el Inventario              
--             YardPosId     : Id de la Posición en el Patio 
--             Block         : Bloque 
--             Row          : Fila 
--             Bay           : Bahia 
--             Stow          : Estiba 
...
IF CHAR_LENGTH(@Comments) <= 0 SELECT @Comments = 'Se cambio la posición a: ' + @YardPosId 
...
--Inserta un registro en la tabla del Histórico de Posición del Contenedor 
